    ...
    with conn.cursor() as cur:
        execute_schema_step(
            ...
            CREATE TABLE IF NOT EXISTS jobs (
                ...
                posted_at_normalization_status TEXT,
                posted_at_normalization_failure_reason TEXT,
                posted_at_normalized_at_utc TIMESTAMPTZ,
                updated_at TEXT,
                job_url TEXT,
                apply_url TEXT,
                content_html TEXT,
        ...
        jobs_column_alters = [
            ...
            "ADD COLUMN IF NOT EXISTS posted_at_normalization_status TEXT",
            "ADD COLUMN IF NOT EXISTS posted_at_normalization_failure_reason TEXT",
            "ADD COLUMN IF NOT EXISTS posted_at_normalized_at_utc TIMESTAMPTZ",
